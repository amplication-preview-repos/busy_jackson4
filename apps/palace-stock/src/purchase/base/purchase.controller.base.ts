    ...
    return await this.service.createPurchase({
      data: {
        ...
        usersPurchasesCreatedUserIdTousers:
          data.usersPurchasesCreatedUserIdTousers
            ? {
                connect: data.usersPurchasesCreatedUserIdTousers,
              }
            : undefined,

        usersPurchasesUpdatedUserIdTousers:
          data.usersPurchasesUpdatedUserIdTousers
            ? {
                connect: data.usersPurchasesUpdatedUserIdTousers,
              }
            : undefined,

        vendors: data.vendors
          ? {
              connect: data.vendors,
            }
          : undefined,
      },
      select: {
