...
const CREATE_INPUT = {
  accountingDepartmentDescription: "exampleAccountingDepartmentDescription",
  accountingDepartmentId: 42,
  amount: 42.424242424,
  comments: "exampleComments",
  createdAt: new Date(),
  id: 42,
  items: "exampleItems",
  requestCollaboratorId: 42,
  requestDepartmentDesc: "exampleRequestDepartmentDesc",
  requestDepartmentId: 42,
  superiorCollaboratorId: 42,
  updatedAt: new Date(),
};
const CREATE_RESULT = {
  accountingDepartmentDescription: "exampleAccountingDepartmentDescription",
