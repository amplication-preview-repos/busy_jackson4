...
@InputType()
class RecurringPaymentCreateNestedManyWithoutConektaPaymentTransacsInput {
...
export { RecurringPaymentCreateNestedManyWithoutConektaPaymentTransacsInput as RecurringPaymentCreateNestedManyWithoutConektaPaymentTransacsInput };
