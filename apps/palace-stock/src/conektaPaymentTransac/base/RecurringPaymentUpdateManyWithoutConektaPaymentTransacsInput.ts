...
@InputType()
class RecurringPaymentUpdateManyWithoutConektaPaymentTransacsInput {
...
export { RecurringPaymentUpdateManyWithoutConektaPaymentTransacsInput as RecurringPaymentUpdateManyWithoutConektaPaymentTransacsInput };
