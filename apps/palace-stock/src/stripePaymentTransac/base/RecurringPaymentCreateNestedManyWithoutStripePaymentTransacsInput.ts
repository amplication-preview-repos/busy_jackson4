...
@InputType()
class RecurringPaymentCreateNestedManyWithoutStripePaymentTransacsInput {
...
export { RecurringPaymentCreateNestedManyWithoutStripePaymentTransacsInput as RecurringPaymentCreateNestedManyWithoutStripePaymentTransacsInput };
