...
@InputType()
class RecurringPaymentUpdateManyWithoutStripePaymentTransacsInput {
...
export { RecurringPaymentUpdateManyWithoutStripePaymentTransacsInput as RecurringPaymentUpdateManyWithoutStripePaymentTransacsInput };
