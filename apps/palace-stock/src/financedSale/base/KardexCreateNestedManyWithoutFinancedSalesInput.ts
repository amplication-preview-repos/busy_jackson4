...
@InputType()
class KardexCreateNestedManyWithoutFinancedSalesInput {
...
export { KardexCreateNestedManyWithoutFinancedSalesInput as KardexCreateNestedManyWithoutFinancedSalesInput };
