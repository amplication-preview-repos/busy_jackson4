...
@InputType()
class ProtectionCertActivationCreateNestedManyWithoutFinancedSalesInput {
...
export { ProtectionCertActivationCreateNestedManyWithoutFinancedSalesInput as ProtectionCertActivationCreateNestedManyWithoutFinancedSalesInput };
