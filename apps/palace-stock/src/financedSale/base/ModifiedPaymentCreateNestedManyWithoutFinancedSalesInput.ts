...
@InputType()
class ModifiedPaymentCreateNestedManyWithoutFinancedSalesInput {
...
export { ModifiedPaymentCreateNestedManyWithoutFinancedSalesInput as ModifiedPaymentCreateNestedManyWithoutFinancedSalesInput };
