...
@InputType()
class LoanedDeviceCreateNestedManyWithoutFinancedSalesInput {
...
export { LoanedDeviceCreateNestedManyWithoutFinancedSalesInput as LoanedDeviceCreateNestedManyWithoutFinancedSalesInput };
