...
@InputType()
class FinancedAccessoryUpdateManyWithoutFinancedSalesInput {
...
export { FinancedAccessoryUpdateManyWithoutFinancedSalesInput as FinancedAccessoryUpdateManyWithoutFinancedSalesInput };
