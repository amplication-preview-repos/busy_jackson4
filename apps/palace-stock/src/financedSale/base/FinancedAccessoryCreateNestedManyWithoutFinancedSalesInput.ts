...
@InputType()
class FinancedAccessoryCreateNestedManyWithoutFinancedSalesInput {
...
export { FinancedAccessoryCreateNestedManyWithoutFinancedSalesInput as FinancedAccessoryCreateNestedManyWithoutFinancedSalesInput };
