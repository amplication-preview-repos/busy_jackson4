...
@InputType()
class LoanedDeviceUpdateManyWithoutFinancedSalesInput {
...
export { LoanedDeviceUpdateManyWithoutFinancedSalesInput as LoanedDeviceUpdateManyWithoutFinancedSalesInput };
