...
@InputType()
class RecurringPaymentCreateNestedManyWithoutFinancedSalesInput {
...
export { RecurringPaymentCreateNestedManyWithoutFinancedSalesInput as RecurringPaymentCreateNestedManyWithoutFinancedSalesInput };
