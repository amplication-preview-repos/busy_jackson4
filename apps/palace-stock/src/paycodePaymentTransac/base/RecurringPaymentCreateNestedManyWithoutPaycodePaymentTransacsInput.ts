...
@InputType()
class RecurringPaymentCreateNestedManyWithoutPaycodePaymentTransacsInput {
...
export { RecurringPaymentCreateNestedManyWithoutPaycodePaymentTransacsInput as RecurringPaymentCreateNestedManyWithoutPaycodePaymentTransacsInput };
