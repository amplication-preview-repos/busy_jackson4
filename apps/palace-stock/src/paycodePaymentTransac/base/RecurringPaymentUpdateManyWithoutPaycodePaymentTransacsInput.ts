...
@InputType()
class RecurringPaymentUpdateManyWithoutPaycodePaymentTransacsInput {
...
export { RecurringPaymentUpdateManyWithoutPaycodePaymentTransacsInput as RecurringPaymentUpdateManyWithoutPaycodePaymentTransacsInput };
