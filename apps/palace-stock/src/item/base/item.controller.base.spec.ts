...
const CREATE_INPUT = {
  codigoArt: "exampleCodigoArt",
  createdUserId: 42,
  descripcionArt: "exampleDescripcionArt",
  fechaModificado: new Date(),
  fechaRegistro: new Date(),
  id: 42,
  ignorarPlazos: "exampleIgnorarPlazos",
  marca: "exampleMarca",
  modelo: "exampleModelo",
  nombreArchivo: "exampleNombreArchivo",
  rutaArchivo: "exampleRutaArchivo",
  updatedUserId: 42,
};
const CREATE_RESULT = {
  codigoArt: "exampleCodigoArt",
...
describe("Item", () => {
  ...
  test("POST /items", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...CREATE_RESULT,
        fechaModificado: CREATE_RESULT.fechaModificado.toISOString(),
  ...
  test("GET /items", async () => {
    await request(app.getHttpServer())
      ...
      .expect([
        {
          ...FIND_MANY_RESULT[0],
          fechaModificado: FIND_MANY_RESULT[0].fechaModificado.toISOString(),
  ...
  test("GET /items/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...FIND_ONE_RESULT,
        fechaModificado: FIND_ONE_RESULT.fechaModificado.toISOString(),
