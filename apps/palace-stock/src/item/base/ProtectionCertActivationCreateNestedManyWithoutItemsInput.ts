...
@InputType()
class ProtectionCertActivationCreateNestedManyWithoutItemsInput {
...
export { ProtectionCertActivationCreateNestedManyWithoutItemsInput as ProtectionCertActivationCreateNestedManyWithoutItemsInput };
