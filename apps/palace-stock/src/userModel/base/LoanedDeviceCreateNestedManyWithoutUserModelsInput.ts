...
@InputType()
class LoanedDeviceCreateNestedManyWithoutUserModelsInput {
...
export { LoanedDeviceCreateNestedManyWithoutUserModelsInput as LoanedDeviceCreateNestedManyWithoutUserModelsInput };
