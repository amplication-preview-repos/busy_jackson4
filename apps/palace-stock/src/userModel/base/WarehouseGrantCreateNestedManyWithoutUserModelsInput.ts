...
@InputType()
class WarehouseGrantCreateNestedManyWithoutUserModelsInput {
...
export { WarehouseGrantCreateNestedManyWithoutUserModelsInput as WarehouseGrantCreateNestedManyWithoutUserModelsInput };
