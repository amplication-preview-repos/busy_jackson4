...
@InputType()
class CollaboratorCreateNestedManyWithoutUserModelsInput {
...
export { CollaboratorCreateNestedManyWithoutUserModelsInput as CollaboratorCreateNestedManyWithoutUserModelsInput };
