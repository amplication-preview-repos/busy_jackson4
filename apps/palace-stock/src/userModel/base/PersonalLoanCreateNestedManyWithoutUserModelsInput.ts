...
@InputType()
class PersonalLoanCreateNestedManyWithoutUserModelsInput {
...
export { PersonalLoanCreateNestedManyWithoutUserModelsInput as PersonalLoanCreateNestedManyWithoutUserModelsInput };
