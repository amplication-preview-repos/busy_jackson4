...
@InputType()
class PurchaseCreateNestedManyWithoutUserModelsInput {
...
export { PurchaseCreateNestedManyWithoutUserModelsInput as PurchaseCreateNestedManyWithoutUserModelsInput };
