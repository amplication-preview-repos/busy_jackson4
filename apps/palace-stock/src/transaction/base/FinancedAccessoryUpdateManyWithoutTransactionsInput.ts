...
@InputType()
class FinancedAccessoryUpdateManyWithoutTransactionsInput {
...
export { FinancedAccessoryUpdateManyWithoutTransactionsInput as FinancedAccessoryUpdateManyWithoutTransactionsInput };
