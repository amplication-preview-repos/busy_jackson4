...
@InputType()
class KardexCreateNestedManyWithoutTransactionsInput {
...
export { KardexCreateNestedManyWithoutTransactionsInput as KardexCreateNestedManyWithoutTransactionsInput };
