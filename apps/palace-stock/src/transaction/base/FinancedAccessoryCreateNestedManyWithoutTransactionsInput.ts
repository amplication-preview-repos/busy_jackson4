...
@InputType()
class FinancedAccessoryCreateNestedManyWithoutTransactionsInput {
...
export { FinancedAccessoryCreateNestedManyWithoutTransactionsInput as FinancedAccessoryCreateNestedManyWithoutTransactionsInput };
