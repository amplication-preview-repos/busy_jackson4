...
@InputType()
class LockedDevBadCustomerCreateNestedManyWithoutCustomersInput {
...
export { LockedDevBadCustomerCreateNestedManyWithoutCustomersInput as LockedDevBadCustomerCreateNestedManyWithoutCustomersInput };
