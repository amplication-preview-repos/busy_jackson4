...
@InputType()
class ProtectionCertActivationUpdateManyWithoutCustomersInput {
...
export { ProtectionCertActivationUpdateManyWithoutCustomersInput as ProtectionCertActivationUpdateManyWithoutCustomersInput };
