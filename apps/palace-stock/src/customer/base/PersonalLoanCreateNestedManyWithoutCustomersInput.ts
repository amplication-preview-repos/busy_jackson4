...
@InputType()
class PersonalLoanCreateNestedManyWithoutCustomersInput {
...
export { PersonalLoanCreateNestedManyWithoutCustomersInput as PersonalLoanCreateNestedManyWithoutCustomersInput };
