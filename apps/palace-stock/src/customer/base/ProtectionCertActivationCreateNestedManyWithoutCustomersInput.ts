...
@InputType()
class ProtectionCertActivationCreateNestedManyWithoutCustomersInput {
...
export { ProtectionCertActivationCreateNestedManyWithoutCustomersInput as ProtectionCertActivationCreateNestedManyWithoutCustomersInput };
