...
@InputType()
class LoanedDeviceCreateNestedManyWithoutCustomersInput {
...
export { LoanedDeviceCreateNestedManyWithoutCustomersInput as LoanedDeviceCreateNestedManyWithoutCustomersInput };
