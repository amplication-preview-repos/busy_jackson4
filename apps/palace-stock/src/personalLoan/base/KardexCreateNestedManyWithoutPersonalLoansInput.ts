...
@InputType()
class KardexCreateNestedManyWithoutPersonalLoansInput {
...
export { KardexCreateNestedManyWithoutPersonalLoansInput as KardexCreateNestedManyWithoutPersonalLoansInput };
