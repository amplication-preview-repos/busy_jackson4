...
@InputType()
class EstimateCreateNestedManyWithoutWarehousesInput {
...
export { EstimateCreateNestedManyWithoutWarehousesInput as EstimateCreateNestedManyWithoutWarehousesInput };
