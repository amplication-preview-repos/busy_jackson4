...
@InputType()
class WarehouseLoanAmountCreateNestedManyWithoutWarehousesInput {
...
export { WarehouseLoanAmountCreateNestedManyWithoutWarehousesInput as WarehouseLoanAmountCreateNestedManyWithoutWarehousesInput };
