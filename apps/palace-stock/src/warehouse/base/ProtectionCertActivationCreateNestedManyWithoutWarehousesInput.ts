...
@InputType()
class ProtectionCertActivationCreateNestedManyWithoutWarehousesInput {
...
export { ProtectionCertActivationCreateNestedManyWithoutWarehousesInput as ProtectionCertActivationCreateNestedManyWithoutWarehousesInput };
