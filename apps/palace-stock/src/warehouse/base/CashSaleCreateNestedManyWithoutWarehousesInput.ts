...
@InputType()
class CashSaleCreateNestedManyWithoutWarehousesInput {
...
export { CashSaleCreateNestedManyWithoutWarehousesInput as CashSaleCreateNestedManyWithoutWarehousesInput };
