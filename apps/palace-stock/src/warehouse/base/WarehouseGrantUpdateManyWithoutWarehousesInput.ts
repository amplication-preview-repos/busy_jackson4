...
@InputType()
class WarehouseGrantUpdateManyWithoutWarehousesInput {
...
export { WarehouseGrantUpdateManyWithoutWarehousesInput as WarehouseGrantUpdateManyWithoutWarehousesInput };
