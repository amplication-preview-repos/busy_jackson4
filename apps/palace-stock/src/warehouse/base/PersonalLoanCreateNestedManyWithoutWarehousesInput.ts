...
@InputType()
class PersonalLoanCreateNestedManyWithoutWarehousesInput {
...
export { PersonalLoanCreateNestedManyWithoutWarehousesInput as PersonalLoanCreateNestedManyWithoutWarehousesInput };
