...
@InputType()
class WarehouseGrantCreateNestedManyWithoutWarehousesInput {
...
export { WarehouseGrantCreateNestedManyWithoutWarehousesInput as WarehouseGrantCreateNestedManyWithoutWarehousesInput };
