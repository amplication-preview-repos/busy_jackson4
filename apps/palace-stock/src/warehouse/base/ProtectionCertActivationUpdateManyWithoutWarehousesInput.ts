...
@InputType()
class ProtectionCertActivationUpdateManyWithoutWarehousesInput {
...
export { ProtectionCertActivationUpdateManyWithoutWarehousesInput as ProtectionCertActivationUpdateManyWithoutWarehousesInput };
