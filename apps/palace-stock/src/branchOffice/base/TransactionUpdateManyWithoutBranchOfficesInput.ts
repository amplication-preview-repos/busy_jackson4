...
@InputType()
class TransactionUpdateManyWithoutBranchOfficesInput {
...
export { TransactionUpdateManyWithoutBranchOfficesInput as TransactionUpdateManyWithoutBranchOfficesInput };
