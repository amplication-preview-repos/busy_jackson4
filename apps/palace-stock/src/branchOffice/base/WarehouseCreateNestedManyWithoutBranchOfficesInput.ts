...
@InputType()
class WarehouseCreateNestedManyWithoutBranchOfficesInput {
...
export { WarehouseCreateNestedManyWithoutBranchOfficesInput as WarehouseCreateNestedManyWithoutBranchOfficesInput };
